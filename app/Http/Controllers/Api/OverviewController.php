...
class OverviewController extends Controller
{
    public function getOverview($project_id)
    {
        try {
            ...
            return response()->json(['message' => 'Fetch Data Successfully', 'information_bridegroom' => ['bride' => $bride, 'groom' => $groom], 'progress_list' => ['totalTask' => $totalTask, 'totalCompleted' => $totalCompleted, 'totalNotCompleted' => $totalNotCompleted]], 200);
        } catch (\Exception $th) {
